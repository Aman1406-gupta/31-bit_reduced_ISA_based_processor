...
architecture sim of tb_Reduced_ISA_Processor is
    ...
    6  => "000111" & "00000" & "01110" & "0000000000000010",                    -- LW    r14 = MEM[r0 + 2]
    7  => "001000" & "10000" & "01101" & "0000000000000100",                    -- SW    MEM[r16 + 4] = r13
    8  => "001001" & "00010" & "00011" & "0000000000000001",                    -- BEQ   if r2 == r3 branch +1
    9  => "001010" & "00111" & "00101" & "0000000000000001",                    -- BNE   if r7 != r5 branch +1
    10 => "001111" & "01111" & "10000" & "0000000000000001",                    -- SLTI  r16 = (r15 < 1) ? 1 : 0
    11 => "010000" & "10000" & "10001" & "0000000000000001",                    -- SLTIU r17 = (r16 < 1) unsigned

    -- R-Type Instructions (Grouped separately)
    12 => "000000" & "00010" & "00011" & "00100" & "00000" & "000000",           -- ADD   r4 = r2 + r3
    13 => "000000" & "00010" & "00011" & "00100" & "00000" & "000001",           -- ADDU  r4 = r2 + r3
    14 => "000000" & "00010" & "00011" & "00100" & "00000" & "000010",           -- SUB   r4 = r2 - r3
    15 => "000000" & "00010" & "00011" & "00100" & "00000" & "000011",           -- SUBU  r4 = r2 - r3 (unsigned)
    16 => "000000" & "00010" & "00011" & "00100" & "00000" & "000100",           -- AND   r4 = r2 & r3
    17 => "000000" & "00010" & "00011" & "00100" & "00000" & "000101",           -- OR    r4 = r2 | r3
    18 => "000000" & "00010" & "00011" & "00100" & "00000" & "000110",           -- XOR   r4 = r2 ^ r3
    19 => "000000" & "00010" & "00011" & "00100" & "00000" & "000111",           -- NOR   r4 = ~(r2 | r3)
    20 => "000000" & "00000" & "00011" & "00100" & "00110" & "001000",           -- SLL   r4 = r3 << 6
    21 => "000000" & "00000" & "00011" & "00100" & "00110" & "001001",           -- SRL   r4 = r3 >> 6 (logical)
    22 => "000000" & "00000" & "00011" & "00100" & "00110" & "001010",           -- SRA   r4 = r3 >> 6 (arithmetic)
    23 => "000000" & "00000" & "00011" & "00100" & "00110" & "001011",           -- ROR   r4 = rotate right r3 by 6
    24 => "000000" & "00010" & "00011" & "00100" & "00000" & "001100",           -- SLT   r4 = (r2 < r3) ? 1 : 0
    25 => "000000" & "00010" & "00011" & "00100" & "00000" & "001101",           -- SLTU  r4 = (r2 < r3) unsigned
        
    --J-Type Instructions
    26 => "010001" & "00000000000000000000000001",                               -- JUMP  to address 1
