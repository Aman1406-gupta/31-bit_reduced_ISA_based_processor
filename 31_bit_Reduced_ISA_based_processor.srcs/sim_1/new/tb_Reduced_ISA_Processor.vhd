...
architecture sim of tb_Reduced_ISA_Processor is
    ...
    6  => "000111" & "00001" & "01110" & "0000000000001000",                    -- LW    r14 = MEM[r0 + 8]
    ...
    11 => "010000" & "10000" & "10001" & "0000000000000001",                    -- SLTIU r17 = (r16 < 1) ? 1 : 0 unsigned

    -- R-Type Instructions (Grouped separately)
    12 => "000000" & "00010" & "00011" & "00100" & "00000" & "000000",           -- ADD   r4 = r2 + r3
    13 => "000000" & "00010" & "00011" & "00100" & "00000" & "000001",           -- ADDU  r4 = r2 + r3 (unsigned)
    ...
    20 => "000000" & "00000" & "00011" & "00100" & "00110" & "001001",           -- SRL   r4 = r3 >> 6 (logical)
    ...
    25 => "000000" & "00010" & "00011" & "00100" & "00000" & "001101",           -- SLTU  r4 = (r2 < r3) ? 1 : 0 unsigned
        
    --J-Type Instructions
    26 => "010001" & "00000000000000000000000000",                               -- JUMP  to Instruction 0
